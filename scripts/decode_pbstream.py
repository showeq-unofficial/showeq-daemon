...
# Envelope.payload oneof field names, kept in sync with proto/seq/v1/events.proto.
KNOWN_KINDS = (
    ...
    "item_totals worn_set eq_time_sync zone_server box_list_updated "
    "map_packages inspect_answer"
).split()
