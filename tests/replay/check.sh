...
for vpk in "${vpks[@]}"; do
    ...
    if ! "${DAEMON}" \
            ...
            --rust-opcodes OP_MobUpdate,OP_DeleteSpawn,OP_ZoneEntry,OP_RemoveSpawn,OP_HPUpdate,OP_MobHealth,OP_SpawnAppearance,OP_ExpUpdate,OP_LevelUpdate,OP_SkillUpdate \
            --listen "127.0.0.1:${PORT}" >>"${log}" 2>&1; then
